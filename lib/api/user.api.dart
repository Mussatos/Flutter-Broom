...
Future<List<dynamic>> fetchAgendamentoByContractor() async {
  final contractorId = await autentication.getUserId();
  final url = Uri.http(host, '/agendamento/contractor/$contractorId');
  final token = await autentication.getToken();
...
Future<List<dynamic>> fetchAgendamentoByDiarist(int diaristaId) async {
  final url = Uri.http(host, '/agendamento/diarist/$diaristaId');
  final token = await autentication.getToken();
...
Future<List<dynamic>> fetchAgendamentoServiceByDiarist(int diaristaId) async {
  final url = Uri.http(host, '/agendamento/diarist/services/$diaristaId');
  final token = await autentication.getToken();
